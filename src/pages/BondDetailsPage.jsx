            ...
            <div className="page-header page-header--row">
                <div>
                    ...
                    <p>
                        ...
                        расчёта результата инвестирования по упрощённой модели.
                    </p>
                </div>
            ...
            <div className="calculation-section">
                ...
                <div className="details-card">
                    ...
                    <p className="muted-text">
                        Расчёт выполняется на стороне backend. Frontend только собирает
                        параметры формы, отправляет их в API и отображает полученный
                        результат.
                    </p>

                    <p className="muted-text">
                        Расчёты в текущем MVP не сохраняются в базе данных.
                    </p>
                </div>
            </div>
